...
<html lang="en">
<head>
<title> EasyMath-Insert-A/L</title>

<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="Keywords" content="easymath,math,mathematics,ansver,question,solution,a/l,a level,advance level,grade 13,grade 12">
...
<div name="q-form" class="col-lg-8" style="background-color: rgb(255,225, 255,.3) ;margin-bottom: 50px; padding: 20px;width: 100%; margin-left: 15%">
		...
		<form class="contact_form" id="contact_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<div class="col-lg-6 contact_name_col">
					<input id="name" name="name" type="text" class="contact_input" placeholder="Name" required="required">
				</div>
				<!-- Email -->
				<div class="col-lg-6">
					<input id="email" name="email" type="email" class="contact_input" placeholder="E-mail">
				</div>
			</div>
			<!-- subject -->
			<div>
