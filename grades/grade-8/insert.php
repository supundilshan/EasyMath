...
<html lang="en">
<head>
<title> EasyMath-Insert-GRADE8</title>

<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="Keywords" content="easymath,math,maths,mathematics,ansver,solution,question,grade 8">
...
//database part
	...
	if(mysqli_select_db($conn,'uploads')){
		...
		if(!$conn->query("DESCRIBE grade8")){
			$create_tb="create table grade8 (number int AUTO_INCREMENT PRIMARY KEY, up_date date not null, s_name varchar(200) not null,text_file varchar(250) not null,attach_file varchar(250),email varchar(250));";
...
//enter data
$sql="insert into grade8 ( up_date , s_name ,text_file ,attach_file ,email ) values ($date,'$s_name','$filename','$attach_file','$email');";
$conn->query($sql);
}
else{
	$msg="";
